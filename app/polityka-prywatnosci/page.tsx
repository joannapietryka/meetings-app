      ...
      >
        ...
        <div className="flex flex-col gap-6 text-slate-700 font-sans text-sm leading-relaxed">
          <section>
            ...
            <p>
              Administratorem danych osobowych jest [Twoje imię/nazwa firmy], kontakt:{" "}
              [email kontaktowy].
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Dane przechowywane są przez okres korzystania z aplikacji oraz do [np. 12 miesięcy]
          ...
          <section>
            ...
            <p>
              Dane mogą być przetwarzane przez podmioty wspierające działanie aplikacji
              (np. hosting, dostawca e-maili).
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              W celu realizacji praw należy skontaktować się pod adresem: [email].
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Dane są przetwarzane z zachowaniem odpowiednich środków bezpieczeństwa.
            </p>
          </section>
        </div>
      </div>
